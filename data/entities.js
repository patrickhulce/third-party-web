module.exports = [
  ...
  },
  {
    ...
    homepage: 'https://developers.google.com/apis-explorer/#p/',
    category: 'utility',
    domains: ['firebasestorage.googleapis.com', 'firestore.googleapis.com', 'firebaseinstallations.googleapis.com', 'firebase.googleapis.com', 'firebaseremoteconfig.googleapis.com'],
  },
  {
  ...
  },
  {
    ...
    company: 'Comodo',
    category: 'utility',
    domains: ['crt.comodoca.com', '*.comodoca4.com', 'ocsp.comodoca.com', 'ocsp.usertrust.com', 'crt.usertrust.com'],
  ...
  },
  {
    ...
    category: 'marketing',
    domains: ['*.associates-amazon.com'],
    examples: ['assoc-na.associates-amazon.com'],
  },
  {
    name: 'DotMetrics',
    company: 'Ipsos',
    homepage: 'https://www.dotmetrics.net/',
    category: 'analytics',
    domains: ['*.dotmetrics.net'],
    examples: ['uk-script.dotmetrics.net'],
  },
  {
    name: 'Truffle Bid',
    company: 'Truffle',
    homepage: 'https://truffle.bid/',
    category: 'ad',
    domains: ['*.truffle.bid'],
    examples: ['matching.truffle.bid'],
  },
  {
    name: 'Hybrid',
    company: 'Hybrid',
    homepage: 'https://hybrid.ai/',
    category: 'ad',
    domains: ['*.hybrid.ai'],
    examples: ['dm-eu.hybrid.ai'],
  },
  {
    name: 'AdMan Media',
    company: 'AdMan',
    homepage: 'https://admanmedia.com/',
    category: 'video',
    domains: ['*.admanmedia.com'],
    examples: ['cs.admanmedia.com'],
  },
  {
    name: 'ID5 Identity Cloud',
    company: 'ID5',
  ...
  {
    name: 'Audience Rate',
    company: 'Audience Rate Limited',
    homepage: 'https://www.audiencerate.com/',
    category: 'ad',
    domains: ['*.audrte.com'],
    examples: ['a.audrte.com'],
  },
  {
    name: 'Seedtag',
    company: 'Seedtag Advertising',
    homepage: 'https://www.seedtag.com/',
    category: 'ad',
    domains: ['*.seedtag.com'],
    examples: ['s.seedtag.com'],
  },
  {
    name: 'IVI',
    company: 'IVI Technologies',
    homepage: 'http://ivitechnologies.com/',
    category: 'ad',
    domains: ['*.ivitrack.com'],
    examples: ['matching.ivitrack.com'],
  },
  {
    name: 'Sportradar',
    company: 'Sportradar',
    ...
    category: 'ad',
    domains: ['*.sportradarserving.com'],
    examples: ['a.sportradarserving.com'],
  },
  {
    name: 'ZEOTAP',
    company: 'ZEOTAP',
    homepage: 'https://zeotap.com/',
    category: 'ad',
    domains: ['*.zeotap.com'],
    examples: ['spl.zeotap.com'],
  },
  {
    name: 'Web Content Assessor',
    company: 'TMT Digital',
    homepage: 'https://mediatrust.com/',
    category: 'ad',
    domains: ['*.webcontentassessor.com'],
    examples: ['scripts.webcontentassessor.com'],
  },
  {
    name: 'Genie',
    company: 'Media Force',
    homepage: 'https://hellogenie.com/',
    category: 'ad',
    domains: ['*.mfadsrvr.com'],
    examples: ['rtb.mfadsrvr.com'],
  },
  {
    name: 'mediarithmics',
    company: 'mediarithmics',
    homepage: 'https://www.mediarithmics.com/',
    category: 'ad',
    domains: ['*.mediarithmics.com'],
    examples: ['cookie-matching.mediarithmics.com'],
  },
  {
    name: 'Ozone Project',
    company: 'The Ozone Project',
    homepage: 'https://www.ozoneproject.com/',
    category: 'ad',
    domains: ['*.the-ozone-project.com'],
    examples: ['elb.the-ozone-project.com'],
  },
  {
    name: 'FiftyAurora',
    company: 'Fifty',
    homepage: 'https://fifty.io/',
    category: 'ad',
    domains: ['*.fiftyt.com'],
    examples: ['visitor.fiftyt.com'],
  },
  {
    name: 'smadex',
    company: 'entravision',
    homepage: 'https://smadex.com/',
    category: 'ad',
    domains: ['*.smadex.com'],
  ...
  },
  {
    ...
    category: 'ad',
    domains: ['*.tm-awx.com'],
    examples: ['felix.data.tm-awx.com'],
  },
  {
    name: 'XPO',
    company: 'Knorex',
    category: 'ad',
    homepage: 'https://www.knorex.com/',
    domains: ['*.brand-display.com'],
    examples: ['dmp.brand-display.com'],
  },
  {
    name: 'Viafoura',
    company: 'Viafoura',
  ...
  },
  {
    ...
    company: 'Adnami',
    category: 'ad',
    homepage: 'https://www.adnami.io/',
    domains: ['*.adnami.io'],
    examples: ['macro.adnami.io'],
  },
  {
    name: 'LiveRamp Privacy Manager',
    company: 'LiveRamp',
    category: 'ad',
    homepage: 'https://liveramp.com/privacy-legal-compliance/',
    domains: ['*.privacymanager.io'],
    examples: ['geo.privacymanager.io'],
  },
  {
    name: 'Onfocus',
    company: 'Onfocus SAS',
  ...
  },
  {
    ...
    category: 'ad',
    homepage: 'https://www.mrpfd.com/',
    domains: ['*.mrpdata.net'],
    examples: ['j.mrpdata.net'],
  },
  {
    name: 'iPROM',
    company: 'iPROM',
    category: 'ad',
    homepage: 'https://iprom.eu/',
    domains: ['*.iprom.net'],
