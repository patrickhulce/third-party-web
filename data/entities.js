module.exports = [
  ...
  },
  {
    ...
    categories: ['cmp'],
    domains: ['admiral.mgr.consensu.org'],
  },
  {
    name: 'Adnuntius',
    homepage: 'https://adnuntius.com',
    categories: ['cmp'],
    domains: ['adnuntiusConsent.mgr.consensu.org'],
  },
  {
    name: 'Clickio',
    homepage: 'https://clickio.com',
    categories: ['cmp'],
    domains: ['clickio.mgr.consensu.org'],
  },
  {
    name: 'AppConsent',
    homepage: 'https://appconsent.io/en',
    categories: ['cmp'],
    domains: ['appconsent.mgr.consensu.org'],
  },
  {
    name: 'DMG Media',
    homepage: 'https://www.dmgmedia.co.uk',
    categories: ['cmp'],
    domains: ['dmgmedia.mgr.consensu.org'],
  },
  {
    name: 'Axel Springer',
    homepage: 'https://www.axelspringer.com',
    categories: ['cmp'],
    domains: ['axelspringer.mgr.consensu.org'],
  },
  {
    name: 'Bedrock',
    homepage: 'https://www.bedrockstreaming.com',
    categories: ['cmp'],
    domains: ['bedrock.mgr.consensu.org'],
  },
  {
    name: 'BMIND',
    homepage: 'https://www.bmind.es',
    categories: ['cmp'],
    domains: ['bmind.mgr.consensu.org'],
  },
  {
    name: 'Borlabs',
    homepage: 'https://borlabs.io',
    categories: ['cmp'],
    domains: ['borlabs.mgr.consensu.org'],
  },
  {
    name: 'Civic',
    homepage: 'https://www.civicuk.com',
    categories: ['cmp'],
    domains: ['cookiecontrol.mgr.consensu.org'],
  },
  {
    name: 'Commanders Act',
    homepage: 'https://www.commandersact.com',
    categories: ['cmp'],
    domains: ['commandersact.mgr.consensu.org'],
  },
  {
    name: 'Complianz',
    homepage: 'https://complianz.io/',
    categories: ['cmp'],
    domains: ['complianz.mgr.consensu.org'],
  },
  {
    name: 'Consent Desk',
    homepage: 'https://www.consentdesk.com/',
    categories: ['cmp'],
    domains: ['consentdesk.mgr.consensu.org'],
  },
  {
    name: 'Consent Manager',
    homepage: 'https://consentmanager.net',
    categories: ['cmp'],
    domains: ['consentmanager.mgr.consensu.org'],
  },
  {
    name: 'Conversant',
    homepage: 'https://www.conversantmedia.eu/',
    categories: ['cmp'],
    domains: ['conversant.mgr.consensu.org'],
  },
  {
    name: 'Cookie Information',
    homepage: 'https://www.cookieinformation.com/',
    categories: ['cmp'],
    domains: ['cookieinformation.mgr.consensu.org'],
  },
  {
    name: 'Cookiebot',
    homepage: 'https://www.cookiebot.com',
    categories: ['cmp'],
    domains: ['cookiebot.mgr.consensu.org'],
  },
  {
    name: 'Truendo',
    homepage: 'https://truendo.com/',
    categories: ['cmp'],
    domains: ['truendo.mgr.consensu.org'],
  },
  {
    name: 'Dentsu',
    homepage: 'https://www.dentsuaegisnetwork.de/',
    categories: ['cmp'],
    domains: ['dan.mgr.consensu.org'],
  },
  {
    name: 'Didomi',
    homepage: 'https://www.didomi.io/en/',
    categories: ['cmp'],
    domains: ['didomi.mgr.consensu.org'],
  },
  {
    name: 'Ensighten',
    homepage: 'https://www.ensighten.com/',
    categories: ['cmp'],
    domains: ['ensighten.mgr.consensu.org'],
  },
  {
    name: 'Evidon',
    homepage: 'https://evidon.com',
    categories: ['cmp'],
    domains: ['evidon.mgr.consensu.org'],
  },
  {
    name: 'Ezoic',
    homepage: 'https://www.ezoic.com/',
    categories: ['cmp'],
    domains: ['ezoic.mgr.consensu.org'],
  },
  {
    name: 'Gemius',
    homepage: 'https://www.gemius.com',
    categories: ['cmp'],
    domains: ['gemius.mgr.consensu.org'],
  },
  {
    name: 'NitroPay',
    homepage: 'https://nitropay.com/',
    categories: ['cmp'],
    domains: ['nitropay.mgr.consensu.org'],
  },
  {
    name: 'Google',
    homepage: 'https://fundingchoices.google.com/start/',
    categories: ['cmp'],
    domains: ['fundingChoices.mgr.consensu.org'],
  },
  {
    name: 'Gravito',
    homepage: 'https://www.gravito.net/',
    categories: ['cmp'],
    domains: ['gravito.mgr.consensu.org'],
  },
  {
    name: 'ID Ward',
    homepage: 'https://id-ward.com/enterprise',
    categories: ['cmp'],
    domains: ['idward.mgr.consensu.org'],
  },
  {
    name: 'iubenda',
    homepage: 'https://www.iubenda.com',
    categories: ['cmp'],
    domains: ['iubenda.mgr.consensu.org'],
  },
  {
    name: 'Jump',
    homepage: 'https://jumpgroup.it/',
    categories: ['cmp'],
    domains: ['avacy.mgr.consensu.org'],
  },
  {
    name: 'LiveRamp',
    homepage: 'https://liveramp.com/',
    categories: ['cmp'],
    domains: ['faktor.mgr.consensu.org'],
  },
  {
    name: 'Madvertise',
    homepage: 'https://madvertise.com/en/',
    categories: ['cmp'],
    domains: ['madvertise.mgr.consensu.org'],
  },
  {
    name: 'Mairdumont Netletic',
    homepage: 'https://www.mairdumont-netletix.com/',
    categories: ['cmp'],
    domains: ['mdnxmp.mgr.consensu.org'],
  },
  {
    name: 'Marfeel',
    homepage: 'https://www.marfeel.com/',
    categories: ['cmp'],
    domains: ['marfeel.mgr.consensu.org'],
  },
  {
    name: 'Mediavine',
    homepage: 'https://www.mediavine.com/',
    categories: ['cmp'],
    domains: ['mediavine.mgr.consensu.org'],
  },
  {
    name: 'ConsentServe',
    homepage: 'https://www.consentserve.com/',
    categories: ['cmp'],
    domains: ['consentserve.mgr.consensu.org'],
  },
  {
    name: 'Next14',
    homepage: 'https://www.next14.com/',
    categories: ['cmp'],
    domains: ['next14.mgr.consensu.org'],
  },
  {
    name: 'AdRoll',
    homepage: 'https://www.adroll.com/',
    categories: ['cmp'],
    domains: ['adroll.mgr.consensu.org'],
  },
  {
    name: 'Ogury',
    homepage: 'https://www.ogury.com/',
    categories: ['cmp'],
    domains: ['ogury.mgr.consensu.org'],
  },
  {
    name: 'OneTag',
    homepage: 'https://onetag.net',
    categories: ['cmp'],
    domains: ['onetag.mgr.consensu.org'],
  },
  {
    name: 'OneTrust',
    homepage: 'https://onetrust.com',
    categories: ['cmp'],
    domains: ['onetrust.mgr.consensu.org'],
  },
  {
    name: 'optAd360',
    homepage: 'https://www.optad360.com/',
    categories: ['cmp'],
    domains: ['optad360.mgr.consensu.org'],
  },
  {
    name: 'Osano',
    homepage: 'https://www.osano.com',
    categories: ['cmp'],
    domains: ['osano.mgr.consensu.org'],
  },
  {
    name: 'Playwire',
    homepage: 'http://playwire.com',
    categories: ['cmp'],
    domains: ['playwire.mgr.consensu.org'],
  },
  {
    name: 'Pulselive',
    homepage: 'https://www.pulselive.com',
    categories: ['cmp'],
    domains: ['pulselive.mgr.consensu.org'],
  },
  {
    name: 'Quantcast',
    homepage: 'https://quantcast.com',
    categories: ['cmp'],
    domains: ['quantcast.mgr.consensu.org'],
  },
  {
    name: 'RCS Pubblicita',
    homepage: 'http://www.rcspubblicita.it/site/home.html',
    categories: ['cmp'],
    domains: ['rcsmediagroup.mgr.consensu.org'],
  },
  {
    name: 'Rich Audience',
    homepage: 'https://richaudience.com',
    categories: ['cmp'],
    domains: ['richaudience.mgr.consensu.org'],
  },
  {
    name: 'Ringier Axel Springer',
    homepage: 'https://www.ringieraxelspringer.pl/en/home/',
    categories: ['cmp'],
    domains: ['rasp.mgr.consensu.org'],
  },
  {
    name: 'Secure Privacy',
    homepage: 'https://secureprivacy.ai/',
    categories: ['cmp'],
    domains: ['securePrivacy.mgr.consensu.org'],
  },
  {
    name: 'Securiti',
    homepage: 'https://securiti.ai/',
    categories: ['cmp'],
    domains: ['securiti.mgr.consensu.org'],
  },
  {
    name: 'Seznam.cz',
    homepage: 'https://www.seznam.cz/',
    categories: ['cmp'],
    domains: ['seznam.mgr.consensu.org'],
  },
  {
    name: 'ShareThis',
    homepage: 'https://sharethis.com',
    categories: ['cmp'],
    domains: ['sharethis.mgr.consensu.org'],
  },
  {
    name: 'ShinyStat',
    homepage: 'https://www.shinystat.com',
    categories: ['cmp'],
    domains: ['shinystat.mgr.consensu.org'],
  },
  {
    name: 'Sibbo',
    homepage: 'http://sibboventures.com/en/',
    categories: ['cmp'],
    domains: ['sibboventures.mgr.consensu.org'],
  },
  {
    name: 'Singlespot',
    homepage: 'https://www.singlespot.com/en',
    categories: ['cmp'],
    domains: ['singlespot.mgr.consensu.org'],
  },
  {
    name: 'Sirdata',
    homepage: 'https://www.sirdata.com',
    categories: ['cmp'],
    domains: ['sddan.mgr.consensu.org'],
  },
  {
    name: 'Snigel',
    homepage: 'http://www.snigelweb.com/',
    categories: ['cmp'],
    domains: ['snigelweb.mgr.consensu.org'],
  },
  {
    name: 'Sourcepoint',
    homepage: 'https://sourcepoint.com',
    categories: ['cmp'],
    domains: ['sourcepoint.mgr.consensu.org'],
  },
  {
    name: 'Pubtech',
    homepage: 'https://www.pubtech.ai/',
    categories: ['cmp'],
    domains: ['pubtech.mgr.consensu.org'],
  },
  {
    name: 'AdMetrics Pro',
    homepage: 'https://admetricspro.com',
    categories: ['cmp'],
    domains: ['cmp.mgr.consensu.org'],
  },
  {
    name: 'Traffective',
    homepage: 'https://traffective.com',
    categories: ['cmp'],
    domains: ['traffective.mgr.consensu.org'],
  },
  {
    name: 'UniConsent',
    homepage: 'https://uniconsent.com',
    categories: ['cmp'],
    domains: ['uniconsent.mgr.consensu.org'],
  },
  {
    name: 'TrustArc',
    homepage: 'https://trustarc.com/',
    categories: ['cmp'],
    domains: ['trustarc.mgr.consensu.org'],
  },
  {
    name: 'Usercentrics',
    homepage: 'https://usercentrics.com',
    categories: ['cmp'],
    domains: ['usercentrics.mgr.consensu.org'],
  },
  {
    name: 'WebAds',
    homepage: 'http://www.webads.nl/',
    categories: ['cmp'],
    domains: ['webads.mgr.consensu.org'],
  },
]
