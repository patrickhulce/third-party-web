...
describe('getEntity', () => {
  it('works for direct domain usage', () => {
    expect(getEntity('https://js.connect.facebook.net/lib.js')).toMatchInlineSnapshot(`
      Object {
        "averageExecutionTime": 387.5616117885821,
        "categories": Array [
          "social",
        ],
        "category": "social",
        ...
        "totalExecutionTime": 1232876894,
        "totalOccurrences": 3181112,
      }
    `)
  })
  ...
  it('works for inferred domain usage', () => {
    expect(getEntity('https://unknown.typekit.net/fonts.css')).toMatchInlineSnapshot(`
      Object {
        "averageExecutionTime": 339.53180320219315,
        "categories": Array [
          "cdn",
        ],
        "category": "cdn",
        ...
        "name": "Adobe TypeKit",
        "products": Array [],
        "totalExecutionTime": 34926618,
        "totalOccurrences": 102867,
      }
    `)
  })
