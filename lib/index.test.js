...
describe('getEntity', () => {
  it('works for direct domain usage', () => {
    expect(getEntity('https://js.connect.facebook.net/lib.js')).toMatchInlineSnapshot(`
      Object {
        "averageExecutionTime": 2324.4622220571446,
        "categories": Array [
          "social",
        ],
        "category": "social",
        ...
        "totalExecutionTime": 12954537117,
        "totalOccurrences": 5573133,
      }
    `)
  })
  ...
  it('works for inferred domain usage', () => {
    expect(getEntity('https://unknown.typekit.net/fonts.css')).toMatchInlineSnapshot(`
      Object {
        "averageExecutionTime": 2682.7087834595154,
        "categories": Array [
          "cdn",
        ],
        "category": "cdn",
        ...
        "name": "Adobe TypeKit",
        "products": Array [],
        "totalExecutionTime": 547814499,
        "totalOccurrences": 204202,
      }
    `)
  })
